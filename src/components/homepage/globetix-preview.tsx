...
const GlobetixPreview = () => {
  const styles = {
    ...
    image: "rounded-lg",
    detailWrapper:
      "w-full xl:w-1/2 flex flex-col lg:justify-between items-center xl:items-start text-right xl:-mr-16 gap-5 z-10",
    ...
    className="flex flex-col xl:flex-row-reverse gap-5 pb-10">
      ...
      <div className={styles.detailWrapper}>
        ...
        <p className={styles.detail}>
          GlobeTix is a fullstack travel booking website, with several destination to choose in Indonesia. It is created
