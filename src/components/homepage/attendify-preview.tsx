...
const AttendifyPreview = () => {
  const styles = {
    previewWrapper: "flex flex-col xl:flex-row gap-5 pb-10",
    imageWrapper: "w-full xl:w-1/2 h-auto relative group",
    image: "rounded-lg",
    detailWrapper: "w-full xl:w-1/2 flex flex-col lg:justify-between items-center xl:items-end text-right xl:-ml-16 gap-5 z-10",
...
export default AttendifyPreview;