...
const Project2 = (props: Props) => {
  return (
    <div className="flex flex-col xl:flex-row-reverse gap-5 pb-10">
      <a className="w-full xl:w-1/2 h-auto relative group" href="https://github.com/KsatriaXDev/GlobeTix" target="_blank">
        <div>
          <Image src={p2} alt="project-2" className="rounded-lg h-full w-full" />
        </div>
      </a>
